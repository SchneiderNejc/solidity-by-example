...
/* Preventative Second Contract
Improvement: Adds a nonce and a mapping executed to track already-executed transactions.
Fix: Every transaction includes a unique nonce, making the hash unique. Once a transaction with a specific hash is executed, it’s marked as executed, preventing reuse.
 */
